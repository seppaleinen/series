...
@NamedQueries(
        @NamedQuery(name = "findEpisodeBySeriesId", query = "select episode from MySQLTVDBEpisode episode where episode.seriesId = :id")
)
public class MySQLTVDBEpisode implements Serializable {
