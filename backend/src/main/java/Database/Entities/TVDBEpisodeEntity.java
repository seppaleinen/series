...
@Entity
@Table(name = "TVDBEPISODE")
@NamedQueries(
        @NamedQuery(name = "findEpisodeBySeriesId", query = "select episode from TVDBEpisodeEntity episode where episode.seriesId = :id")
)
public class TVDBEpisodeEntity implements Serializable {
